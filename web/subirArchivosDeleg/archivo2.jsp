...
%>
    <table border=0 bgcolor='orange'>
        <tr>
            <td  class='lbl_detalle' style='background-color:orange'>&nbsp;&nbsp; </td>
            <td valign=top>
            ...
            <!--td align=right>
                <input type="checkbox" id="cbox2" value="first_checkbox"> Firmar<br>
                <input type="checkbox" id="cbox2" value="second_checkbox"> Sellar<br>
            </td-->
        </tr>
     </table>
</body>
