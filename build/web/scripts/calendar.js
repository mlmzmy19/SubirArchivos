...
bottomBorder    =true;
windowSize      ="width=200,height=215";
...
var delim, val, DayFormat, DayStr; //used to for next 2 functions to communicate
	...
	function showCalendar(dateField,Format,Title,dateField1) {
 ...
 writeCalendar();
	...
	function getMonthSelect() {
		...
		monthSelect += "</SELECT>";
                ...
                monthSelect = "<SELECT NAME='month' onChange='parent.opener.setCurrentMonth()'><OPTION SELECTED>Enero<OPTION>Febrero<OPTION>Marzo<OPTION>Abril<OPTION>Mayo<OPTION>Junio<OPTION>Julio<OPTION>Agosto<OPTION>Septiembre<OPTION>Octubre<OPTION>Noviembre<OPTION>Diciembre</SELECT>";
		return monthSelect;
		}
