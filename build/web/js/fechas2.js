...
function restafechas(fechaexp1,Idfechas)
	{
	...
	var resulresta = (Math.ceil((fechaexp2.getTime()-today.getTime())/(one_day)))


	today2=new Date();
	var mesa = today2.getMonth()+1;
	var diaa = today2.getDate();
	var yeara = today2.getYear();
	var yeara2 = String(yeara);
	yeara2 = yeara2.substr(2,4);
	var fechaactual= diaa +"/"+ mesa +"/"+ yeara2;

		//alert("1="+fechaactual);
	var resultadoendias = recalcF3(fechaactual,resulresta);
...
////////////// nuevo codigo
  ...
  ///////Segundo calculo
    ...
    function recalcF3(form, resulresta){
...
for (h=0; h<resulresta; h++)    
{
  ...
  for (Z=1; Z <= resulresta; Z++)    {
                       ...
                       {    
                            --J;                                   //alert ("Fecha a validar="+fechaJ);
                       }
