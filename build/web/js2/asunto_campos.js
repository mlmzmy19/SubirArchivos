      ...
      function otros_campos_asuntos(cadena_clase){
                    ...
                    datoW1 = tiposCasos_Asunto(Intclase);
                  ...
                  datoW2 = datoW1.split(",");
                    ...
                    for(x=0; x<datoW2.length; x++){
                         ...
                         if(x==0 || x%3==0 || datoW2[x]==8){
                            ...
                            cell.setAttribute("className", "Subtitulos");

                            //if(Campos[datoW2[x]][0]!="..")
                                text_asuntos = document.createTextNode("  "+Campos[datoW2[x]][0]);
                                //text_asuntos.name = "desc_"+Campos[datoW2[x]][1];
                            ...
                            if( Campos[datoW2[x]][1].indexOf("text")!=-1){ 
                                    ...
                                    if( Campos[datoW2[x]][1].indexOf("hidden")!=-1) 
                                        input_asuntos.type = 'hidden';                        
                                    else
                                        input_asuntos.type = 'text';           

                                    input_asuntos.value= "";
                                    if( Campos[datoW2[x]][1].indexOf("text_asunto_fec_ocu_hechos")!=-1 || Campos[datoW2[x]][1].indexOf("text_asunto_inic_vigen")!=-1 || Campos[datoW2[x]][1].indexOf("text_asunto_term_vigen")!=-1 || Campos[datoW2[x]][1].indexOf("text_asunto_fec_ope_imp")!=-1){
                                        input_asuntos.onkeypress = function (){ LP_data2(this)} ; //Este no va aqui

                                        if(Campos[datoW2[x]][1].indexOf("text_asunto_fec_ocu_hechos")!=-1){  // esto es para restar dos fechas

                                                input_asuntos.onchange   = function (){ return validarDosFechas(document.registro.anio_Sistema,this,1); }; //Este no va aqui

                                        }else if(Campos[datoW2[x]][1].indexOf("text_asunto_term_vigen")!=-1){

                                                input_asuntos.onchange   = function (){ return validarDosFechas(document.registro.text_asunto_inic_vigen,this,2); }; //Este no va aqui

                                        }else{
                                                input_asuntos.onchange   = function (){ valFecha(this) }; //Este no va aqui
                                        }



                                        //input_asuntos.value      = "dd/mm/yyyy";
                                            //LP_data2(document.registro.text_usuario_fec_doc)
                                    }

                                    if( Campos[datoW2[x]][1].indexOf("text_asunto_monto_rec")!=-1){
                                        input_asuntos.onkeypress = function (){ return esInteger(event) } ; //Este no va aqui
                                        input_asuntos.onchange   = function (){ valMontoASunto() }; //Este no va aqui
                                    }

                                    input_asuntos.size = 15;
                                    input_asuntos.style.background='#EDEDED';
                            ...
                            if( Campos[datoW2[x]][1].indexOf("selec")!=-1){ 
                                    ...
                                    input_asuntos.style.background='#EDEDED';
                                    input_asuntos.id = Campos[datoW2[x]][1];
                                    for(ka=0; ka<13; ka++){    // Creamos dinamicamente todos los objetos con variables
                                                    eval("var selec_asunto_opt"+ka+"e = document.createElement('option');"); 
                                                }
                                    selec_asunto_opt0e.value = "0"; 
                                    selec_asunto_opt1e.value = "12";                    selec_asunto_opt2e.value = "3";
                                    selec_asunto_opt3e.value = "6";                    selec_asunto_opt4e.value = "8";
                                    selec_asunto_opt5e.value = "5";                   selec_asunto_opt6e.value = "4";
                                    selec_asunto_opt7e.value = "10";                    selec_asunto_opt8e.value = "7";
                                    selec_asunto_opt9e.value = "1";                   selec_asunto_opt10e.value = "11";
                                    selec_asunto_opt11e.value = "2";                  selec_asunto_opt12e.value = "9";
                                    
                                    var selec_asunto_text0e = document.createTextNode('Tipo de Moneda');   
                                    var selec_asunto_text1e = document.createTextNode('Dólar Canadiense');                var selec_asunto_text2e = document.createTextNode('Dolares'); 
                                    var selec_asunto_text3e = document.createTextNode('Euro');                            var selec_asunto_text4e = document.createTextNode('Franco'); 
                  ...
                  var combo_indice_ins_asunto2 = document.registro.selec_divcasosEsp0.selectedIndex;
                      ...
                      if(combo_indice_ins_asunto2>0){
                                ...
                                //var VenPop = window.open("casosEspRegistro/masInstituciones.jsp?mas_ins_origen="+mas_ins_origen.split(",")[0]+"&indice_mas_ins="+indice_mas_ins+"&combo_indice_ins_asunto2="+combo_indice_ins_asunto2,"VenMas",'width=700,height=260,status=1,left='+arriba+',top='+izquierda);
                                    ...
                                    return GB_show('Mas Instituciones', '../../../../sio_web/casosEspRegistro/masInstituciones.jsp?mas_ins_origen='+mas_ins_origen.split(",")[0]+'&indice_mas_ins='+indice_mas_ins+"&combo_indice_ins_asunto2="+combo_indice_ins_asunto2,300,900);

                       }else
                                alert("Seleccione la Institución.")
                  }else
                                alert("Seleccione una Clase Institución.")
        ...
        function ArregloCampos_Asunto(){

                  Campos = new Array(1);

                  for (var i=0; i<27; i++) {  // 27 por q es el tamaño de los arreglos
                    ...
                    Campos[0][0]="Fecha en que ocurrieron los hechos(dd/mm/yyyy):";
                    ...
                    Campos[12][0]="Fecha de la operacion impugnada(dd/mm/yyyy):";
                    Campos[12][1]="text_asunto_fec_ope_imp";                                                                                

                    Campos[13][0]="Numéro de Poliza :";
                    ...
                    Campos[17][0]="Inicio de vigencia(dd/mm/yyyy):";
                    Campos[17][1]="text_asunto_inic_vigen";     
                    
                    Campos[18][0]="Termino de Vigencia(dd/mm/yyyy):";
                    ...
                    Campos[26][0]="";
                    Campos[26][1]="text_hidden_asunto_afore";   
        ...
        function tiposCasos_Asunto(Intclase){
                    ...
                    switch(Intclase){
						...
						case    25: datoW1='0,2,3,9,8';                                 break;  //Condusef
                                                ...
                                                case    21: datoW1='0,1,2,3,4,5,6,7,8,26';                      break;  //procesar
                                                ...
                                                case    999:datoW1='8';                                         break;  //Tipo caso Anonimo de registro
                                         }
