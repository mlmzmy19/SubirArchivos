...
%>
    <table border=0  bgcolor='pink'>
        <tr>
            <td  class='lbl_detalle' style='background-color:pink'>&nbsp;&nbsp;  </td>
            <td valign=top>
            ...
            <input type="hidden" id="consecutivo" name="consecutivo" value="5" />              
            ...
            <!--td align=right>
                <input type="checkbox" id="cbox5" value="first_checkbox"> Firmar<br>
                <input type="checkbox" id="cbox5" value="second_checkbox"> Sellar<br>
            </td-->
        </tr>
     </table>
</body>
