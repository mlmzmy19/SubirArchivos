	...
	*/	
	...
	This function captures whether or not user enabled cookies or not
	*/	
	function fingerprint_deviceprint () 
	{					
		var deviceprint;	
		deviceprint = fingerprint_browser() + DEV 
		deviceprint 	+=	fingerprint_display() + DEV 
						+ fingerprint_software() + DEV 
						+ fingerprint_timezone() + DEV
						+ fingerprint_language() + DEV
						+ fingerprint_java() + DEV
						+ fingerprint_cookie() + DEV;
	...
	*/	
	...
	{
		var t = "version=" + ver +
		    "&pm_fpua=" + fingerprint_browser("")  + 
			"&pm_fpsc=" + fingerprint_display("")  + 
			"&pm_fpsw=" + fingerprint_software("") + 
			"&pm_fptz=" + fingerprint_timezone("") + 
			"&pm_fpln=" + fingerprint_language("") + 
			"&pm_fpjv=" + fingerprint_java("")     + 
			"&pm_fpco=" + fingerprint_cookie("");
	...
	*/		
    ...
    /*
	Seccion para el manejo de COOKIES
	*/
